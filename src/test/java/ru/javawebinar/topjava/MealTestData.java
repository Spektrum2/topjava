...
public class MealTestData {
    ...
    public static final LocalDate ADMIN_START_DATE = LocalDate.of(2020, Month.JANUARY, 28);
    public static final LocalDate ADMIN_END_DATE = LocalDate.of(2020, Month.JANUARY, 29);
    ...
    public static final Meal adminMeal = new Meal(ADMIN_MEAL_ID, LocalDateTime.of(2020, Month.JANUARY, 29, 10, 0), "Завтрак - Омлет", 500);
    public static final Meal adminMeal1 = new Meal(START_SEQ + 11, LocalDateTime.of(2020, Month.JANUARY, 29, 13, 0), "Обед - Борщ", 500);
    public static final Meal adminMeal2 = new Meal(START_SEQ + 12, LocalDateTime.of(2020, Month.JANUARY, 29, 20, 0), "Ужин - Пицца", 1000);
    public static final Meal adminMeal3 = new Meal(START_SEQ + 13, LocalDateTime.of(2020, Month.JANUARY, 28, 10, 0), "Завтрак - Яичница", 600);
    public static final Meal adminMeal4 = new Meal(START_SEQ + 14, LocalDateTime.of(2020, Month.JANUARY, 28, 13, 0), "Обед - Окрошка", 500);
    public static final Meal adminMeal5 = new Meal(START_SEQ + 15, LocalDateTime.of(2020, Month.JANUARY, 28, 20, 0), "Ужин - Паста", 1000);
