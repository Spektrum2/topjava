...
<form action="meals"  method="post">
    ...
    <input type="datetime-local" class="date" id="date" name="date" value="${not empty meal ? meal.dateTime : date}" required>
    <br>
    <label for="description">Description:</label>
    <input type="text" size="30" class="description" id="description" name="description" value="${meal.description}" required>
    <br>
    <label for="calories">Calories:</label>
    <input type="number" class="calories" id="calories" name="calories" value="${meal.calories}" required>
    <br>
